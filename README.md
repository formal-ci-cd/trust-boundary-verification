...
成果物を複数run間で受け渡すGHA-A1からGHA-A4の構成は，[GitHub Actions成果物実験](experiments/github-actions/artifact/README.md)に記録しています．静的解析の比較は[成果物実験の静的解析結果](results/github-actions-artifact-static-analysis-2026-08-22.md)，形式検証は[成果物経路の形式検証結果](results/github-actions-artifact-formal-model-2026-08-22.md)，GitHub上での確認結果は[成果物経路の実行結果](results/github-actions-artifact-runtime-2026-08-22.md)を参照してください．CodeQL抽出結果からの自動結合方法と4構成の評価は[CI/CD共通モデル](model/README.md)に記録しています．
